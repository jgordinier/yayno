...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (!msg) {
			return 'https://ia801509.us.archive.org/1/items/yay_20200404/YAY.mp3';
		} else {
			return 'https://ia801405.us.archive.org/35/items/no_20200404/No.mp3';
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Just use the controls... ')
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('yesbox'),
								$elm$html$Html$Attributes$src('https://ia801509.us.archive.org/1/items/yay_20200404/YAY.mp3')
							]),
						_List_Nil)
					]))
			]));
